...
const NAV_ITEMS: NavItem[] = [
  { href: "/", label: "Inicio", icon: IconHome, roles: ["admin", "recepcion", "tecnico"] },
  { href: "/ordenes", label: "Órdenes", icon: IconClipboard, roles: ["admin", "recepcion", "tecnico"] },
  { href: "/clientes", label: "Clientes", icon: IconUsers, roles: ["admin", "recepcion", "tecnico"] },
  { href: "/inventario", label: "Inventario", icon: IconPackage, roles: ["admin", "recepcion", "tecnico"] },
  { href: "/caja", label: "Caja", icon: IconWallet, roles: ["admin", "recepcion"] },
  { href: "/movil", label: "Móvil", icon: IconSmartphone, roles: ["admin", "tecnico"] },
];

const NAV_ADMIN: NavItem[] = [
  { href: "/admin/reportes", label: "Reportes", icon: IconChart, roles: ["admin"] },
  { href: "/admin/usuarios", label: "Usuarios", icon: IconCog, roles: ["admin"] },
];
